...
# Dictionnaire pour stocker les événements 
    ...
    date2 = Date(10, 12, 2026)

    # Test de la classe Date
    print("Date 1 :", date1)
    print("Date 1 est passée ?", date1.est_passee())

    print("Date 2 :", date2)
    print("Date 2 est passée ?", date2.est_passee())
    ...
    for id_event, event in evenements.items():
        print(f"ID {id_event} :", event)
